...
export class UsageRate extends Component {
  ...
  handlePlantTable(evt) {
    ...
    for (let i = 0; i < this.state.plants.length; i++) {
      if (
        (this.state.plants[i].Commentaire === "") &
        (this.state.plants[i].Element === "")
      )
        counters++;
    }
      ...
      <div className="content">
        <div className="container-fluid">
          <div className="row">
            ...
            />
            <PlantsBar
              nbText={this.state.nbText}
              onUserInput={this.handlePlantsInput.bind(this)}
            />
            <PlantTable
              ...
              <thead>
                <tr>
                  <th colSpan="1" className="Rowcss">
                    <b>
                      Usage Rate :{" "}
                      {(1 - (EmptyItemCounter / plant.length).toFixed(2)) * 100}{" "}
                      %{" "}
                    </b>
                  </th>
                </tr>
